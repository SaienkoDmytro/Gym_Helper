...
public class AddProjectActivity extends AppCompatActivity {
    ...
    private void initDropDownIntensity() {
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1, intensityName);
    ...
    private void initDropDownSets() {
        ArrayAdapter<Integer> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1, setsCount);
